...
const Plastic = () => {
  ...
  useEffect(() => {
    fetch(`https://naina-toys-server.vercel.app/plastic`)
      .then(res => res.json())
                ...
                <Card style={{ width: '19rem' }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      ...
                      <h5><div className="d-flex align-items-center">
                    ...
                    <Link to={`/toy/${item._id}`}> <Button variant="primary">View Details</Button></Link>
                  </Card.Body>
                </Card>
